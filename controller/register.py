...
class RegistrationForm(Form):
    ...
    username = StringField('Nombre de usuario ', [validators.Length(min=4, max=25, message="Longitud incorrecta")], default='Nombre de usuario...', render_kw={'class': text_class})
    ...
    contact = StringField('Número de teléfono ', [validators.Length(min=9, max=9, message="Longitud incorrecta"), validators.InputRequired()])
    ...
    s_num = IntegerField('Número ', [validators.InputRequired(f"Campo {label} vacío.")], default='Escriba el número de su calle/plaza/avenida...', render_kw={'class': text_class})
    s_story = IntegerField('Piso ', [validators.InputRequired()], default='Escriba el número de su piso', render_kw={'class': text_class})
