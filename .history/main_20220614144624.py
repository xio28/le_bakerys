...
def admin_panel():
    ...
    return template('admin_panel', formEmp=formEmp, formPro=formPro, per  prows=Productos.select(), incrows=Clientes.inner_cliente(), inerows=Empleados.inner_empleado())
