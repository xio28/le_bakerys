...
def admin_panel():
    ...
    return template('admin_panel', formEmp=formEmp, formPro=formPro, odrows=Pedidos  prows=Productos.select(), incrows=Clientes.inner_cliente(), inerows=Empleados.inner_empleado())
