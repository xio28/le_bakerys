...
def admin_panel():
    ...
    return template('admin_panel', formEmp=formEmp, formPro=formPro,  prows=Productos.select(), crows=Clientes.field_select(['ID', 'Email', 'Nombre', 'NIF', 'Calle', 'Codigo_Postal', 'Ciudad']), inrows=Empleados.inner_empleado())
